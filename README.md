...
**Примечание:** IP-адреса могут изменяться. Рекомендуется периодически обновлять их с официальных источников или через скрипты (например, с помощью `dig` или внешних API).
